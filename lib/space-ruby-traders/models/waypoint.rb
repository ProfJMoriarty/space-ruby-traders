...
module SpaceRubyTraderClient
  ...
  class Waypoint
    ...
    attr_accessor :is_under_construction
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SpaceRubyTraderClient::Waypoint` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SpaceRubyTraderClient::Waypoint`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_under_construction')
        self.is_under_construction = attributes[:'is_under_construction']
      else
        self.is_under_construction = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @is_under_construction.nil?
        invalid_properties.push('invalid value for "is_under_construction", is_under_construction cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @is_under_construction.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          chart == o.chart &&
          is_under_construction == o.is_under_construction
    end
    ...
    def hash
      [symbol, type, system_symbol, x, y, orbitals, orbits, faction, traits, modifiers, chart, is_under_construction].hash
    end
